                    ...
                    <table className="w-full table-auto min-w-full">
                        <thead>
                            <tr className="bg-green-100 rounded-t-2xl">
                                {columns.map((col) => (
                                    <th key={col.key} className="text-left px-4 py-3 font-semibold text-black dark:text-dark-800 whitespace-nowrap">
                                        {col.header}
                                    </th>
                                ))}
                            </tr>
                            ...
                            {isLoading
                                ...
                                : paginatedData.map((row, i) => (
                                    <tr key={i} className="border-b dark:border-white/10">
                                        {columns.map((col) => (
                                            <td key={col.key} className="px-4 py-4 align-middle text-black dark:text-light/40  whitespace-nowrap">
